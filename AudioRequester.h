...
class AudioRequester
{
 ...
 public:
	...
	static std::shared_ptr<const sf::SoundBuffer> GetClipData(const AudioClip& clip);
 ...
 private:
	...
	inline static std::unordered_map<int16_t, std::shared_ptr<sf::SoundBuffer>> s_SoundEmitters;
